...
We begin by identifying speakers within text. In non-conversational text, we
use a simple heuristic that searches for the subjects of reporting verbs (e.g.,
say) in the same sentence or neighboring sentences to a quotation. In
conversational text, speaker information is provided in the data set.'''

from utils import mergeClustersByMentionIDs, get_mention_id_list_per_sentence

replist = ['begin', 'onthul', 'loof', 'kondig_aan', 'beweer', 'breng_in',
        'deel_mee', 'merk_op', 'zeg_op', 'spreek', 'breng_uit', 'druk_uit',
        'uit', 'spreek_uit', 'verklaar', 'verkondig', 'vermeld', 'vertel',
        'verwoord', 'duid_aan', 'benoem', 'tendeer_in', 'meen', 'noem',
        'oordeel', 'stel', 'vind', 'beduid', 'behels', 'beteken', 'bewijs',
        'beveel', 'gebied', 'draag_op', 'neem_aan', 'veronderstel', 'merk_aan',
        'verwijt', 'beloof', 'zeg_toe', 'schrijf_voor', 'geef_aan', 'stip_aan',
        'kondig_af', 'maak_bekend', 'bericht', 'beschrijf', 'declareer',
        'gewaag', 'meld', 'geef_op', 'neem_op', 'teken_op', 'relateer',
        'proclameer', 'publiceer', 'rapporteer', 'leg_vast', 'vernoem',
        'versla', 'zeg', 'betoon', 'betuig', 'manifesteer', 'openbaar',
        'peer_op', 'slaak', 'spui', 'sla_uit', 'stort_uit', 'stoot_uit',
        'vertolk', 'ventileer', 'deponeer', 'expliciteer', 'getuig', 'ontvouw',
        'pretendeer', 'doe_uiteen', 'zet_uiteen', 'verzeker', 'kleed_in',
        'lucht', 'breng_over', 'toon', 'vervat', 'geef_weer', 'betoog',
        'claim', 'suggereer', 'houd_vol', 'geef_voor', 'wend_voor', 'verdedig',
        'spreek_aan', 'bestempel', 'betitel', 'kwalificeer', 'som_op',
        'draai_af', 'debiteer', 'deel_mede', 'dis_op', 'kraam_uit', 'verhaal',
        'poneer', 'postuleer', 'leg_voor', 'fluister']
